...
import { RotateCcw, ArrowLeft, CheckCircle, ShieldCheck } from 'lucide-react';
...
export const RefundPage: React.FC<RefundPageProps> = ({ data }) => {
  const parsed = parsePolicyMarkdown(data.refund, 'REFUND POLICY');
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="bg-bg border border-border rounded-lg p-10 mb-16 shadow-sm">
          <div className="flex items-center gap-3 text-accent mb-6">
            <RotateCcw size={20} />
            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-foreground-dim">Service Guarantee Protocol</span>
          </div>
          ...
          <p className="text-sm sm:text-base text-foreground-muted font-normal leading-relaxed text-balance">
            {parsed.subtitle || 'Uncompromising performance standards. Review our deterministic satisfaction commitment for all Ryzen™ infrastructure deployments.'}
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-4 space-y-8 h-fit lg:sticky lg:top-32">
            <div>
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-accent block mb-4">Policy Navigation</span>
            ...
            <div className="bg-bg border border-border p-6 rounded-lg space-y-4 shadow-sm">
              ...
              <p className="text-[11px] text-foreground-muted leading-relaxed font-normal uppercase tracking-wider">
                Deterministic performance thresholds. Zero compromise on hardware integrity or compute throughput.
              </p>
            </div>
          </div>
