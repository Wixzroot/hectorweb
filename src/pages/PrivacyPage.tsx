...
export const PrivacyPage: React.FC<PrivacyPageProps> = ({ data }) => {
  const parsed = parsePolicyMarkdown(data.privacy, 'PRIVACY POLICY');
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="bg-bg border border-border rounded-lg p-10 mb-16 shadow-sm">
          <div className="flex items-center gap-3 text-accent mb-6">
            <Lock size={20} />
            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-foreground-dim">Infrastructure Governance</span>
          </div>
          ...
          <p className="text-sm sm:text-base text-foreground-muted font-normal leading-relaxed text-balance">
            {parsed.subtitle || 'Deterministic policies regarding the security of your computing records, source code, and application telemetry.'}
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-4 space-y-8 h-fit lg:sticky lg:top-32">
            <div>
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-accent block mb-4">Topology Navigation</span>
            ...
            <div className="bg-bg border border-border p-6 rounded-lg space-y-4 shadow-sm">
              <div className="text-foreground font-black text-[10px] uppercase tracking-widest flex items-center gap-3">
                <ShieldCheck size={16} className="text-emerald-500" /> Statutory Compliance
              </div>
              <p className="text-[11px] text-foreground-muted leading-relaxed font-normal uppercase tracking-wider">
                Database systems adhere to global data protection protocols. Zero unauthorized log retention policies.
              </p>
            </div>
          </div>
