...
export const DEFAULT_DATA: AppData = {
  ...
  incidents: [
    ...
    },
    {
      ...
      message: 'All hypervisors, Game Control Panel, Pterodactyl daemon wings, and DDoS mitigation tunnels across Delhi & Mumbai facilities are operating at nominal SLA.',
      createdAt: 'Today'
    }
  ],
  privacy: `
